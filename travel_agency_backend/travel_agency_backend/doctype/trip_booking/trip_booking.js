...
frappe.ui.form.on("Trip Booking", {
  refresh: function (frm) {
    ...
    const serviceMap = {
      ...
      "Flight Multi City Online": ["flight_multicity_section", "flight_booking_entry_multicity", "flight_multicity_supplier"],
      "Flight Multi City GDS": ["flight_multicity_section", "flight_booking_entry_multicity", "flight_multicity_supplier"],
          ...
          (values) => {
            ...
            if (!table_exists) {
              ...
              const serviceTypeToSelectWbjnMap = {
                ...
                "Flight Multi City Online": "Flight Multi City Online",
                "Flight Multi City GDS": "Flight Multi City GDS",
              ...
              if (!service_exists) {
                ...
                // Multi-city functionality has been removed
              }
